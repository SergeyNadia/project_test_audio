 ...
 */
export const getGenerateMusicUrl = () => {
  return `/api/generate`;
};
...
export const generateMusic = async (
  ...
  return customFetch<TaskStatus>(getGenerateMusicUrl(), {
    ...options,
    method: "POST",
...
export const getGenerateMusicMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof generateMusic>>,
    TError,
  ...
  TContext
> => {
  const mutationKey = ["generateMusic"];
  ...
  > = (props) => {
    ...
    return generateMusic(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type GenerateMusicMutationResult = NonNullable<
  Awaited<ReturnType<typeof generateMusic>>
>;
export type GenerateMusicMutationBody = BodyType<GenerateRequest>;
export type GenerateMusicMutationError = ErrorType<ErrorResponse>;
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getGenerateMusicMutationOptions(options));
};
...
export const getTaskStatus = async (
  ...
  return customFetch<TaskStatus>(getGetTaskStatusUrl(taskId), {
    ...options,
    method: "GET",
  });
};
...
export const getGetTaskStatusQueryKey = (taskId: string) => {
  return [`/api/status/${taskId}`] as const;
};

export const getGetTaskStatusQueryOptions = <
  TData = Awaited<ReturnType<typeof getTaskStatus>>,
  TError = ErrorType<ErrorResponse>,
>(
  taskId: string,
  options?: {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getTaskStatus>>> = ({
    signal,
  }) => getTaskStatus(taskId, { signal, ...requestOptions });
...
export type GetTaskStatusQueryResult = NonNullable<
  Awaited<ReturnType<typeof getTaskStatus>>
>;
